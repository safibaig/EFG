...
describe LoanDemandToBorrowersController do
  describe '#new' do
    ...
    it 'works with a loan from the same lender' do
      loan = FactoryGirl.create(:loan, :guaranteed, lender: current_lender)
    ...
    it 'raises RecordNotFound for a loan from another lender' do
      ...
      loan = FactoryGirl.create(:loan, :guaranteed, lender: other_lender)
  ...
  describe '#create' do
    ...
    def dispatch(params = {})
      default_params = { loan_id: loan.id, loan_demand_to_borrower: {} }
