...
describe LoanCancelsController do
  describe '#new' do
    ...
    it 'works with a loan from the same lender' do
      loan = FactoryGirl.create(:loan, :eligible, lender: current_lender)
    ...
    it 'raises RecordNotFound for a loan from another lender' do
      ...
      loan = FactoryGirl.create(:loan, :eligible, lender: other_lender)
