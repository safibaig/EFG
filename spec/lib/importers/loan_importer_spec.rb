...
describe LoanImporter do
  ...
  describe "#attributes" do
    ...
    let(:importer) { LoanImporter.new(row, 100) }
    ...
    it "should return a hash of user attributes" do
      importer.attributes.should == {
        ...
        :repayment_duration                  => { years: 0, months: "60" },
        ...
        :dti_demand_outstanding              => "79999.96",
        :borrower_demand_outstanding         => "300",
