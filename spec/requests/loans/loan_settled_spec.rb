...
describe "loan settled" do
  ...
  it "setting loans" do
    ...
    FactoryGirl.create(:loan, id: 1, reference: 'BSPFDNH-01', lender: lender1)
    FactoryGirl.create(:loan, id: 2, reference: '3PEZRGB-01', lender: lender1)
    FactoryGirl.create(:loan, id: 3, reference: 'LOGIHLJ-02', lender: lender1)
    FactoryGirl.create(:loan, id: 4, reference: 'MF6XT4Z-01', lender: lender1)
    FactoryGirl.create(:loan, id: 5, reference: 'MF6XT4Z-01', lender: lender2)
