...
describe 'Remove guarantee' do
  ...
  it 'should remove guarantee from loan' do
    ...
    fill_in 'remove_guarantee_remove_guarantee_on', with: '20/05/2012'
    fill_in 'remove_guarantee_remove_guarantee_outstanding_amount', with: '10000'
    fill_in 'remove_guarantee_remove_guarantee_reason', with: 'n/a/'
