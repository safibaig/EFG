...
class LoanReport
  ...
  ALLOWED_LOAN_STATES = Loan::States + ['all']

  ALLOWED_LOAN_TYPES = [ Loan::SFLG_SOURCE, Loan::LEGACY_SFLG_SOURCE ]

  ALLOWED_LOAN_SCHEMES = [ Loan::EFG_SCHEME, Loan::SFLG_SCHEME ]

  attr_accessor :facility_letter_start_date, :facility_letter_end_date,
                :created_at_start_date, :created_at_end_date, :loan_state,
                :created_by_user_id, :loan_type, :loan_scheme, :lender_id
